...
public class updateActivity extends AppCompatActivity {
    ...
    private Playermodel updatePlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updatePlayer= (Playermodel) getIntent().getSerializableExtra("update");

        updateToolbar= findViewById(R.id.updatetoolId);
        tollBarText= findViewById(R.id.toolTextId);
        tollBarText.setText("Update");
        setSupportActionBar(updateToolbar);

        //view find...
        indexTextView= findViewById(R.id.updateId);
        nameEditText= findViewById(R.id.updateName);
        codeEditText= findViewById(R.id.updateCode);
        updatePlayerText= findViewById(R.id.updateType);
