...
public class UpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void updateData(int id, String name, String code, String type) {
        ...
        if(value==-1){
            ...
            Intent intent= new Intent(UpdateActivity.this, com.example.classroomdatabase.MainActivity.class);
    ...
    private void openDialogue() {
        ...
        final View view= inflater.inflate(R.layout.type_dailouge,null);
